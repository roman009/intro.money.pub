...
function MainPage() {
  ...
  const [
    currentDisplayedConversation,
    setCurrentDisplayedConversation,
  ] = useState(null);
  ...
  const createConversation = async () => {
    ...
    try {
      let web3Instance = await web3();
      let contractInstance = await contract();
      console.log("create conversation: " + bnbUsdRate * replyReward);
      await contractInstance.methods
        .createConversation(
          web3Instance.utils.utf8ToHex(encryptedMessage),
          //web3Instance.utils.toWei(0)
          web3Instance.utils.toWei("0"),
          web3Instance.utils.toWei(bnbUsdRate * replyReward + "")
        )
        .send({ from: account });
  ...
  const handleDeposit = async () => {
    ...
    console.log("deposit amount: " + bnbInput * bnbUsdRate + "");
    await contractInstance.methods.deposit().send({
      from: accounts[0],
      value: web3Instance.utils.toWei(bnbInput * bnbUsdRate + ""),
    });
  ...
  const handleWithdrawal = async () => {
    ...
    await contractInstance.methods
      .withdraw(web3Instance.utils.toWei(bnbInput))
    ...
    return (
      <div className="mainPage">
        <div className="container">
                  ...
                  <div className="deposit_balance">
                    {userBnb !== "0" ? (
                      ...
                      >
                        ...
                        <a className="depositText">{cutBNB} BNB</a>
                      </div>
                    )}
                  </div>
                </div>
          ...
          >
            <div className="balance">
              ...
              <div className="balanceFunds">
                <div className="balanceFundsUSD">{userUsd} USD</div>
                <div className="balanceFundsBNB">{cutBNB} BNB</div>
              </div>
          ...
          >
            <div className="balance">
              <div className="balanceHeading">Deposit BNB</div>
          ...
          >
            <div className="balance">
              <div className="balanceHeading">Withdraw BNB</div>
              <div>
                <input
                  className="balanceDepositInput"
                  placeholder="0.01"
