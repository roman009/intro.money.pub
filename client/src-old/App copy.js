...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.messages.length > 0) {
      displayMessages = this.state.messages.map((message) => (
        <li key={message.id}>
          {message.id}. "
          {this.state.web3.utils.hexToUtf8(message.encryptedMessages[0])}"
        </li>
      ));
    }
            ...
            <ul>
              {this.state.conversations.map((conversation) => (
                <li key={conversation.id}>
                  <Link to={`/#/${conversation.id}`}>{conversation.id}</Link>.
    ...
    return (
      <div className="App">
        ...
        <p></p>
        <div>Is logged in: {this.state.isLoggedIn ? "yes" : "no"}</div>
        <p></p>
        <div>Is registered: {this.state.isRegistered ? "yes" : "no"}</div>
        <p></p>
        ...
        <form id="create-message">
          ...
          <label>
            ...
            <input
              type="text"
              name="password3"
              onChange={this.handlePassword3Change}
            ></input>
          </label>
          <br></br>
          <label>
            ...
            <input
              type="text"
              name="read-reward"
              onChange={this.handleReadRewardChange}
            ></input>
          </label>
          <br></br>
          <label>
            ...
            <input
              type="text"
              name="reply-reward"
              onChange={this.handleReplyRewardChange}
            ></input>
          </label>
          <br></br>
          <button onClick={this.createMessage}>Create Message</button>
        </form>
        <p></p>
        <div>
          Messages:
        ...
        <div>
          ...
          <label>
            ...
            <textarea
              ...
              onChange={this.handleMessageDecryptChange}
            />
          </label>
          <br></br>
          <label>
        ...
        <form id="create-conversation">
          ...
          <br></br>
          <button onClick={this.createConversation}>Create Conversation</button>
        </form>
        <br></br>
        <br></br>
      </div>
